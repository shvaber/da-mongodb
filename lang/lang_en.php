PLUGIN_HOME_TITLE="MongoDB Management";
PLUGIN_HOME_DESCRIPTION="Here you can manage MongoDB databases available for your account";
PLUGIN_FOOTER_TITLE="Plugin version %s written by Poralix";

PLUGIN_ADMIN_MONGO_ERROR="PHP extension mongodb is not loaded. You need to build PHP with mongodb module.";
PLUGIN_ADMIN_MONGO_OK="The mongodb module is loaded in PHP - OK";
PLUGIN_ADMIN_MONGO_CONNECT_ERROR="PHP function pg_connect() is not available. You need to build PHP with mongodb module.";
PLUGIN_ADMIN_MONGO_CONNECT_OK="PHP can connect to MongoDB - OK";
PLUGIN_ADMIN_MONGO_CONNECTED_ERROR="Failed to connect to MongoDB server with a password authentication. You might need to check its settings.";
PLUGIN_ADMIN_MONGO_CONNECTED_OK="Connected to MongoDB server with a password authentication - OK";
...
PLUGIN_GO_BACK="Back";
PLUGIN_GO_BACK_LINK="<a href='/CMD_PLUGINS/mongodb/?'>Go back</a>";
PLUGIN_RELOAD="Reload";
PLUGIN_LOADING_STATUS="Loading...";

PLUGIN_CONNECT_MONGOADMIN="Connect to MongoDB";
...
TRY_AGAIN_LATER="<a href='?'>Try again later...</a>";
...
ERROR_MESSAGE_MONGO_NOT_ALLOWED="You are not allowed to create MongoDB databases";
ERROR_DETAILS_MONGO_NOT_ALLOWED="Your hosting package does not allow to use MongoDB server. Contact your hosting company for more details";
ERROR_MESSAGE_MONGO_LIMIT_HIT="A limit on number of databases hit";
ERROR_DETAILS_MONGO_LIMIT_HIT="You are not allowed to create more databases. Contact your hosting company for more details";
...
ERROR_MESSAGE_FAILED_MONGOADMIN="Failed to open phpMongoAdmin";
ERROR_DETAILS_FAILED_MONGOADMIN="An error occurred while redirecting to phpMongoAdmin. Contact your hosting company for more details";
