PLUGIN_HOME_TITLE="Управление MongoDB";
PLUGIN_HOME_DESCRIPTION="Управляйте базами MongoDB на своем аккаунте";
PLUGIN_FOOTER_TITLE="Плагин версии %s написан командой Poralix";

PLUGIN_ADMIN_MONGO_ERROR="PHP расширение mongodb не доступно. Пересоберите PHP с поддержкой модуля mongodb.";
PLUGIN_ADMIN_MONGO_OK="PHP расширение доступно - OK";
PLUGIN_ADMIN_PG_CONNECT_ERROR="PHP функция pg_connect() не доступна. Пересоберите PHP с поддержкой модуля mongodb.";
PLUGIN_ADMIN_PG_CONNECT_OK="PHP функция pg_connect() доступна - OK";
PLUGIN_ADMIN_PG_CONNECTED_ERROR="Попытка подключения к серверу MongoDB с паролем не удалась. Проверьте настройки сервера MongoDB и плагина.";
PLUGIN_ADMIN_PG_CONNECTED_OK="Подключение к серверу MongoDB прошло успешно - OK";
...
PLUGIN_GO_BACK_LINK="<a href='/CMD_PLUGINS/mongodb/?'>Вернуться назад</a>";
PLUGIN_RELOAD="Обновить";
PLUGIN_LOADING_STATUS="Идет загрузка...";

PLUGIN_CONNECT_MONGODB="Подключиться к phpMongoAdmin";
...
TRY_AGAIN_LATER="<a href='?'>Попробуйте еще раз позже...</a>";
...
ERROR_MESSAGE_MONGO_NOT_ALLOWED="Вам не разрешено создаать Базы Данных на сервере MongoDB";
ERROR_DETAILS_MONGO_NOT_ALLOWED="Ваш тарифный план не поддерживает создание Баз Данных на сервере MongoDB. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_MESSAGE_MONGO_LIMIT_HIT="Достигнут лимит на количество Баз Данных";
ERROR_DETAILS_MONGO_LIMIT_HIT="Вам не разрешается создавать новые базы данных на сервере MongoDB. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_MESSAGE_FAILED_CREATE_DB="База Данных не создана";
ERROR_DETAILS_FAILED_CREATE_DB="Во время создания новой базы данных на сервере MongoDB произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_MESSAGE_FAILED_DOWNLOAD="Загрузка провалилась";
ERROR_DETAILS_FAILED_DOWNLOAD="Во время создания резервной копии базы данных на сервере MongoDB произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_DETAILS_FAILED_LIST_DATABASES="Во время получения списка баз данных на сервере MongoDB произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
...
ERROR_DETAILS_FAILED_ACTION_ON_DB="Во время выполнения запрошенной операции на сервере MongoDB произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_MESSAGE_FAILED_RESTORE_DB="Не могу восстановить базу данных";
ERROR_DETAILS_FAILED_RESTORE_DB="Во время восстановления базы данных из резервной копии на сервере MongoDB произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
ERROR_DETAILS_FAILED_CONNECT_DB="Во время подключения к серверу MongoDB произошла ошибка. Неверное сочетанию имени пользователя и пароля.";
...
ERROR_MESSAGE_FAILED_MONGODB="Не могу открыть phpMongoAdmin";
ERROR_DETAILS_FAILED_MONGODB="Во время подключения к phpMongoAdmin произошла ошибка. Обратитесь в вашу хостинг компанию за дополнительной информацией";
