    ...
    (function( $ ) {
        $(function()
        {
            ...
            var px_dropError = function(message)
            {
                ...
                if ($("#px-message-container").length) $("#px-message-container").hide();
                $("#px-mongoadmin-container").addClass("sr-only");
            }
            ...
            {
                var method = "GET";
                var url = '/CMD_PLUGINS/mongodb/validate.raw?type=username&value='+$("#px_input_db_user").val();
                $.ajax({
                    url: url,
                    type: method,
                    dataType: 'json',
            ...
            {
                // px_td_owner
                if ($("td.px_td_owner").length) {
                    $("td.px_td_owner").each(function(){
                        el_val = $(this).html();
                        if (el_val != "system") {
                            $(this).html('<a href="/CMD_SHOW_USER?user='+el_val+'" class="text-dark" target="_top">'+el_val+'</a>');
                        } else {
                            $(this).html('<div class="text-muted">'+el_val+'</div>');
                        }
                    });
                }
                ...
                $("button#px_plugin_db_create_link").click(function(){
                    location.href="/CMD_PLUGINS/mongodb/create.html";
                });
                $("button#px_plugin_db_restore_link").click(function(){
                    location.href="/CMD_PLUGINS/mongodb/restore.html";
                });
                $("button#px_plugin_back_link").click(function(){
                    location.href="/CMD_PLUGINS/mongodb/";
                });
                ...
                $("#px_plugin_db_vacuum").click(function(event){
                    ...
                    var url = '/CMD_PLUGINS/mongodb/vacuum.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                ...
                $("#px_plugin_db_reindex").click(function(event){
                    ...
                    var data = $("#px_plugin_db_actions_form").serialize();
                    var method = $("#px_plugin_db_actions_form").attr('method');
                    var url = '/CMD_PLUGINS/mongodb/reindex.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                    px_processRequest(url, method, data);
                });
                ...
                $("#px_plugin_db_delete").click(function(event){
                    ...
                    var data = $("#px_plugin_db_actions_form").serialize();
                    var method = $("#px_plugin_db_actions_form").attr('method');
                    var url = '/CMD_PLUGINS/mongodb/delete.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                    px_processRequest(url, method, data);
                });
                ...
                $("#px_plugin_user_delete").click(function(event){
                    ...
                    var url = '/CMD_PLUGINS/mongodb/deluser.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                    px_processRequest(url, method, data);
                });
                ...
                $("#px_plugin_create_db_form").submit(function(event){
                    ...
                    var url = '/CMD_PLUGINS/mongodb/create.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                    px_processRequest(url, method, data);
                ...
                $("#px_plugin_restore_db_form").submit(function(event){
                    ...
                    var method = $(this).attr('method');
                    var url = '/CMD_PLUGINS/mongodb/restore.raw?r='+Math.random();
                    px_hideMessages();
                    px_startPreload();
                    px_processRequest(url, method, data);
                ...
                $("#px_plugin_database_form").submit(function(event){
                    ...
                    var data = $(this).serialize();
                    var method = $(this).attr('method');
                    var url = '/CMD_PLUGINS/mongodb/database.raw?r='+Math.random();
